...
import gradio as gr
from resumeproject.src.resume_generator import generate_resume
from resumeproject.src.job_matcher import match_resume_to_job
from resumeproject.src.enhancer import suggest_enhancements
from resumeproject.src.job_recommender import recommend_jobs
...
with gr.Blocks() as demo:
    ...
    with gr.Column(visible=False) as gen_ui:
        ...
        edu = gr.Textbox(label="Education", placeholder="e.g., Degree, Department, Year, University")
